...
// import ourpurposehalal from '../../assets/images/ourpurposehalal.png';
    ...
    <div className="about-page">
      ...
      <section className="about-hero">
        ...
        <div className="about-hero__image-block">
          {/* <img src={ourpurposehalal} alt="Мама и ребенок в поле" className="about-hero__image" /> */}
      ...
      <section className="about-family">
        {/* <img src="../../assets/images/webPics/aboutusfamilepicture.png" alt="Семья за столом" className="about-family__image" /> */}
